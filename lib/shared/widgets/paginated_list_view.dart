...
import 'package:education_live_app/shared/widgets/loading_widget.dart';
import 'package:education_live_app/shared/widgets/smooth_list_view.dart';
...
class _PaginatedListViewState extends State<PaginatedListView<dynamic>> {
  ...
  void _scrollListener() {
    ...
    if (widget.showScrollToTop)
      setState(() => _showScrollToTop = _controller.offset > 200);
...
class CustomListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final loader =
        loadingWidget ?? const Center(child: LoadingWidget(size: 20));
    return isSmoothListView
        ? SmoothListView.builder(
            ...
            itemBuilder: (context, index) =>
                index < itemCount ? itemBuilder(context, index) : loader,
