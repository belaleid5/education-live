import 'package:education_live_app/core/theme/colors/colors_dark.dart';
import 'package:education_live_app/core/theme/colors/colors_light.dart';
...
class MyColors extends ThemeExtension<MyColors> {
  ...
  final Color selektonizerLaoding;
  final Color stroke;
  final Color shades;
  final Color button;
  final Color icon;
  ...
  const MyColors({
    ...
    required this.selektonizerLaoding,
  ...
  static const light = MyColors(
    ...
    selektonizerLaoding: AppColorsLight.selektonizerLaoding,
...
extension MyColorsExtension on BuildContext {
  MyColors get colors => Theme.of(this).extension<MyColors>() ?? MyColors.light;
}
